...
<html lang="en" dir="ltr">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../styles/consultar/styles-consultar-.css">
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../turma/ConsultarTurma.jsp" class="active">
            <i class='bx bx-search' ></i>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Consultar Turma</span>
      </div>
    </nav>
