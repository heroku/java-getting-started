...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../styles/cadastrar/styles-cadastrar-professor.css">
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../professor/CadastrarProfessor.jsp" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Cadastrar Professor</span>
      </div>
    </nav>
    ...
    <div class="modal">
		...
		<form action="../CadastrarProfessor" name="professor" method="post" class="alterarAlunoForm">
			...
			<br>
			<div>
				<input onclick="validarProfessor()" id="Button" type="submit" name="salvar"
