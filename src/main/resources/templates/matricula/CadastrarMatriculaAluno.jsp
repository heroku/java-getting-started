...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../styles/cadastrar/styles-cadastrar-aluno.css">
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../matricula/CadastrarMatriculaAluno.jsp" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Cadastrar Aluno</span>
      </div>
    </nav>
    ...
    <div class="modal">
		...
		<form action="../CadastrarMatriculaAluno" name="matricula" method="post"  class="cadastrarAlunoForm">
			...
			<select name="cdcurso">
				...
				ArrayList<?> cursos = new Curso().consultarPorId();
				for(int s=0; s<(cursos.size()) && s<6; s++){
				curso = (Curso) cursos.get(s); 
				%>
				...
				ArrayList<?> turmas = new Turma().consultarPorId();
				for(int s=0; s<(turmas.size()) && s<6; s++){
				turma = (Turma) turmas.get(s); 
				%>
			...
			<br>
			<div>
				<input onclick="validarMatricula()" id="Button" type="submit" name="salvar"
