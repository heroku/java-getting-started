...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../styles/cadastrar/styles-cadastrar-nota.css">
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../nota/CadastrarNota.jsp" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Cadastrar Nota </span>
      </div>
    </nav>
    ...
    <div class="modal">
		...
		<form action="../buscarNota" method="post"  class="cadastrar-nota-Form">
			<div>
