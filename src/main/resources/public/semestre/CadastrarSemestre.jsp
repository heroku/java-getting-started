  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../semestre/CadastrarSemestre.jsp" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Cadastrar Semestre</span>
      </div>
    </nav>
    ...
    <div class="modal">
		...
		<form action="../CadastrarSemestre" name="semestre" method="post" class="cadastrarCursoForm">
			...
			<br>
			<div>
				<input onclick="validarSemestre()" id="Button" type="submit" name="salvar"
